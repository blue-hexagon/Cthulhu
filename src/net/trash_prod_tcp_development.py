...
if __name__ == "__main__":
    ...
    def send(f_obj, msg):
        f_obj.writelines(bytes(msg + "\n"))
        f_obj.flush()

    def read(f_obj) -> str:
        msg = f_obj.readline().decode("utf-8")
        return msg
